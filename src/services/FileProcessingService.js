...
class FileProcessingService {
  ...
  // Validate file size
  validateFileSize(filePath, maxSizeBytes = 10 * 1024 * 1024) { // 10MB default
  ...
  async detectFileType(filePath) {
    try {
      ...
      if (fileContent.includes("Entry ID") && 
          (fileContent.includes("Contest ID") || fileContent.includes("Contest Name"))) {
