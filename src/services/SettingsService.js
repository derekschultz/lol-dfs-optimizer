...
class SettingsService {
  ...
  async updateSettingCategory(category, categorySettings) {
    ...
    const validatedSettings = this.validateCategorySettings(
      category,
      categorySettings
    );
  ...
  getSettingsSchema() {
    return {
      ...
      fieldSize: {
        ...
        min: 10,
        max: 10000,
        description: "Contest field size",
      },
      entryFee: {
        type: "number",
        min: 0.25,
      ...
      maxExposure: {
        ...
        min: 1,
        max: 100,
        description: "Maximum player exposure percentage",
      },
      minPlayers: {
        type: "number",
        min: 3,
        max: 10,
        description: "Minimum players in lineup",
      },
      maxPlayers: {
        type: "number",
        min: 3,
        max: 10,
        description: "Maximum players in lineup",
      },
      salaryCapBuffer: {
        type: "number",
        min: 0,
        max: 5000,
        description: "Salary cap buffer amount",
      },
